        ...
        <ul class="List_noticias">
           ...
           <?php
              while($post = $stmt-> fetch()){
                $stmt_2    = $dbh ->prepare('select  id_imagen_prueba, nombre_imagen_1, id_prueba_manejo from automoviles.imagenes_pruebas_manejo where id_prueba_manejo = "'.$post["id_prueba"].'"');
                $stmt_2  -> execute(); 
                $post_2 = $stmt_2-> fetch();
                  ...
                  {  
                    ...
                    { ?>
                      <li>
                        <a href="despliegue-pruebas.php?id-prueba=<?php echo $post['id_prueba'];?>" target="_blank"><img src="upload/pruebas-manejo/<?php echo $post_2['nombre_imagen_1'];?>" alt="<?php echo  $post['titulo_prueba'];?>" /></a>
                ...
                <?php
                            ...
                            <li>
                              <a href="despliegue-pruebas.php?id-prueba=<?php echo $post['id_prueba'];?>"><img src="upload/pruebas-manejo/<?php echo  $post_2['nombre_imagen_1'];?>" alt="<?php echo  $post['titulo_prueba'];?>" /></a>
