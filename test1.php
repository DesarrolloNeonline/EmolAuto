...
<head>
  ...
  <script  type="text/javascript" src="js/jquery.refineslide.min.js"></script>
  <script type="text/javascript" src="http://apps.emol.com/widgets/mapas/v3/xygo.min.js"></script>
  ...
  <script>
		function procesar()
		{
			...
			location.href="resultado-busqueda-concesionario.php?q="+id_concesionario; 
		}
...
?>
  <div id="wrap">
    ...
    <div id="header">
       ...
       <div id="logo"><a href="index.php"/><img src="img/Logo.jpg" alt="Emol automviles" /></a></div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    ...
    <?php
        ...
        <div class="btn_rojo" style="width:100%;"><a style="cursor: pointer;width: 288px;" onclick="procesar()"  style="width:100%; padding:0;">VER TODOS LOS AUTOS DE ESTA AUTOMOTORA</a></div>
